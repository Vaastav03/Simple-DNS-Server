...
#creating a UDP socket for ads3
adserver=socket.socket(socket.AF_INET,socket.SOCK_DGRAM)
#binding the socket to the port number startportnum+59 as given in question
adserver.bind((nrip,startportnum+59))
...
while True:
    ...
    #if the domain(message) is in ads3
    if msg in ads:
