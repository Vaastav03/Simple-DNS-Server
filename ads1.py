...
#creating a UDP socket for ads1
adserver=socket.socket(socket.AF_INET,socket.SOCK_DGRAM)
#binding the socket to the port number startportnum+57 as given in question
adserver.bind((nrip,startportnum+57))
...
while True:
    ...
    #if the domain(message) is in ads1
    if msg in ads:
