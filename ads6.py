...
#creating a UDP socket for ads6
adserver=socket.socket(socket.AF_INET,socket.SOCK_DGRAM)
#binding the socket to the port number startportnum+62 as given in question
adserver.bind((nrip,startportnum+62))
...
while True:
    ...
    #if the domain(message) is in ads6
    if msg in ads:
