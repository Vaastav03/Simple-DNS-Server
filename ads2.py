...
#creating a UDP socket for ads2
adserver=socket.socket(socket.AF_INET,socket.SOCK_DGRAM)
#binding the socket to the port number startportnum+58 as given in question
adserver.bind((nrip,startportnum+58))
...
while True:
    ...
    #if the domain(message) is in ads2
    if msg in ads:
